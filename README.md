...
When enabled, as shown in the example below, Linzer adds the required
...
Linzer.sign!(
  ...
  # web_bot_auth: true,     # or just use this option to apply defaults,
  # web_bot_auth: {         # or override specific settings this way:
  #   nonce: :none,
  #   agent: "https://example.com/my-cool-agent",
  #   params: :recommended
  # }
)
```
