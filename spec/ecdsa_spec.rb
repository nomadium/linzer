...
RSpec.describe Linzer::Verifier do
  context "with ECDSA using Curve P-256 and SHA-256" do
    ...
    # XXX: investigate why it fails
    xit "fails to verify an invalid signature" do
      pubkey = Linzer.new_ecdsa_p256_sha256_key(test_key_ecc_p256_pub, key_id)
      message = Linzer::Message.new(response_data)
    ...
    # XXX: investigate why cannot be verified
    # signature example from RFC has 64 bytes, but the ones generated by
    # OpenSSL ruby binding has 71 or 72 bytes.
    xit "verifies a valid signature" do
      pubkey = Linzer.new_ecdsa_p256_sha256_key(test_key_ecc_p256_pub, key_id)
      message = Linzer::Message.new(response_data)
